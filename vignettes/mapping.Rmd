...
fhm_pins_geo <- fhm_pins_geo %>%
  ...
  mutate(
    an = recode_factor(
      ...
      "FORD HEIGHTS PARK DISTRICT" = "FH PARK",
      "VILLAGE OF FORD HEIGHTS" = "FH VILLAGE",
...
Here we can see four taxing districts: a library, a park district, the municipality, and a TIF. The park district and municipality overlap almost perfectly, but the library district is slightly larger. Meanwhile, the TIF district covers only a small commercial strip along Route 20.
