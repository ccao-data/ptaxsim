...
| **`year`**              | int        | 1   | See [tax_bill() outputs](#table1)                                                                                          |
| **`pin`**               | varchar(14) | 2   | See [tax_bill() outputs](#table1).       
| **`tax_code`**          | varchar(5) | 3   | See [tax_bill() outputs](#table1). Unique identifier for the *tax situation* created by the TIF      |
| **`agency_num`**        | varchar(9) | 4   | See [tax_bill() outputs](#table1). Unique identifier for the TIF                                                           |
| **`agency_name`**       | varchar    |     | See [tax_bill() outputs](#table1)                                                                                          |
| **`agency_major_type`** | varchar    |     | See [tax_bill() outputs](#table1)                                                                                          |
| **`agency_minor_type`** | varchar    |     | See [tax_bill() outputs](#table1)                                                                                          |
...
* The input `data.table` must be [keyed](https://cran.r-project.org/web/packages/data.table/vignettes/datatable-keys-fast-subset.html) on the `year`, `pin`, `tax_code` and `agency_num` columns and must be ***distinct***, e.i. it must not have repeat rows
