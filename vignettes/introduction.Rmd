...
```{r}
bills <- tax_bill(2006:2020, c("13264290020000", "07101010391078", "10153080520000"))
print(bills, topn = 3)
```
...
```{r}
bills <- tax_bill(c(2012, 2006, 2020), c("13264290020000", "07101010391078", "10153080520000"))
print(bills, topn = 3)
```
...
* Filled by **`lookup_tax_code()`**:
  ...
  * Follows the same recycling rules as `tax_bill()`: input vectors of the same length return an element-wise output, input vectors of different lengths return the Cartesian product.
    ...
    ```{r}
    tax_code <- lookup_tax_code(2018:2020, c("13264290020000", "07101010391078", "10153080520000"))
    print(tax_code)
    
    tax_code <- lookup_tax_code(2006:2020, c("13264290020000", "07101010391078", "10153080520000"))
    print(tax_code)
    ```
...
* Filled by **`lookup_agency()`**:
  ...
  * Note that it returns a distinct set of districts, even if year and tax code are repeated:
    ...
    ```{r}
    tax_codes <- lookup_tax_code(2020, c("13264290020000", "13264290020000", "13264290020000"))
