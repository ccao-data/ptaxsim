...
```{r}
# Query the PTAXSIM database for tax code tax rates from 2012 to 2023 which are joined to our list of North tri tax codes that have existed in each of those years
...
```{r}
# Query the CCAO Open Data PIN Universe to get all North tri PINs for tax year 2023
north_tri_pins <- GET(
  base_url,
  query = list(
    year = 2023,
