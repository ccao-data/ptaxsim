...
1. If a **PIN** received a Senior Freeze exemption, its taxable value is the frozen EAV as granted by the exemption.
2. If a **PIN** didn't receive the Senior Freeze exemption, but it did receive other exemptions that reduce its taxable value, the value of its exemptions must be subtracted from its EAV.
