...
*A note about the equalizer*: Our appeals counterfactual experiment does not incorporate the impact of using the tentative equalizer rather than the final equalizer in calculating tax bills in the pre-appeal stage. Arguably the scenario in which pre-appeal values are used should use the tentative equalizer as we typically see a slight increase in the final equalizer once the Board's reductions are considered. The Illinois Department of Revenue (IDOR), who is responsible for calculating the equalizer, argues that the value of the equalizer does not impact tax bills. *However*, it does in fact impact the relative value of most homestead exemptions which are applied as flat reductions to a property's EAV. Because of the nature of most exemptions, impact of a higher equalizer does further shift the burden on to residential PINs. We do not incorporate the impact of the higher final equalizer here due to the challenges of rebuilding the taxing districts' tax base with the tentative equalizer, but we wanted to note it as a point of consideration - in a true and perfect counterfactual, we would likely see a slightly larger increase of residential tax bills in the `board` stage.
...
Holding commercial appeals constant makes their effect on residential tax bills clearer: large commercial appeals shift the property tax burden back to residential property owners. In the case of Chicago, the drop in commercial AVs during the second level of review (at the Board of Review) contributed to a roughly 9% rise in the median residential tax bill.
