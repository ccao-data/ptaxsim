...
* How do exemptions affect my tax bill? What if a new exemption is created?
...
<summary>*Click here* to show code for plot</summary>
...
For more advanced usage, such as large area or counterfactual analysis, see the [vignettes page](https://ccao-data-science---modeling.gitlab.io/packages/ptaxsim/articles/index.html).
...
<summary>*Click here* to show full database diagram</summary>
